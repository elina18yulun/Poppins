...
restouran.forEach(function(restouran) {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (clickCount === 1) {
      this.src = "./img_book/pag3.png"; 
    } else if (clickCount === 2) {
      this.src = "./img_book/pag4.png"; 
    } else if (clickCount === 3) {
      this.src = "./img_book/pag5.png";
      clickCount = 0; 
    }
    });
  });
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    if (clickCount === 1) {
      this.src = "./img_book/pag6.png"; 
    } else if (clickCount === 2) {
      this.src = "./img_book/pag7.png"; 
    } else if (clickCount === 3) {
      this.src = "./img_book/pag8.png";
      clickCount = 0; 
    }
    });
  });
